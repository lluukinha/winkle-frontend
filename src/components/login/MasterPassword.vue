          ...
          <form @submit="checkMasterPassword">
            <div class="flex justify-center items-center">
              ...
              <button
                ...
                class="bg-gray-300 hover:bg-gray-400 px-2 py-2 rounded rounded-tl-none rounded-bl-none"
              >
                <!-- EYE ICON -->
                <svg v-if="!isShowingMasterPassword" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button class="bg-green-300 hover:bg-green-400 rounded p-2 px-4 ml-2">
                {{ $t('enter') }}
              </button>
            </div>
            <div>
